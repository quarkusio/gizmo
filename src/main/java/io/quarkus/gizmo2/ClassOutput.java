...
public interface ClassOutput {
     ...
     *     <li>either {@link ConstantDescs#CD_Class} (for dynamic constants) or {@link ConstantDescs#CD_MethodType} (for {@code invokedynamic} call sites)</li>
     * </ul>
     * Furthermore, if the method is a for an {@code invokedynamic} bootstrap, its return type must be {@link ConstantDescs#CD_CallSite}.
