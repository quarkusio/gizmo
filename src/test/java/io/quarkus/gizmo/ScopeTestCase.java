...
public class ScopeTestCase {
    ...
    public void testSimpleScopes() throws Exception {
        ...
        try (ClassCreator creator = ClassCreator.builder().classOutput(cl).className("com.MyTest").interfaces(MyInterface.class)
            ...
            ResultHandle equalsResult = scope.invokeVirtualMethod(
                    MethodDescriptor.ofMethod(Object.class, "equals", boolean.class, Object.class), scope.getMethodParam(0),
                    scope.load("TEST"));
    ...
    public void testContinueScope() throws Exception {
        ...
        try (ClassCreator creator = ClassCreator.builder().classOutput(cl).className("com.MyTest").interfaces(Supplier.class)
            ...
            tb.invokeVirtualMethod(MethodDescriptor.ofMethod(StringBuilder.class, "append", StringBuilder.class, String.class),
                    sb,
                    tb.invokeStaticMethod(MethodDescriptor.ofMethod(Integer.class, "toString", String.class, int.class), val));
            tb.invokeVirtualMethod(MethodDescriptor.ofMethod(StringBuilder.class, "append", StringBuilder.class, String.class),
                    sb, tb.load("-"));
            tb.assign(val, tb.invokeStaticMethod(
                    MethodDescriptor.ofMethod(Math.class, "addExact", int.class, int.class, int.class), val, tb.load(-1)));
