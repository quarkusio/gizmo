                ...
                mc.body(b0 -> {
                    ...
                    b0.autoClose(ds, b1 -> {
                        b1.forEach(ds, (b2, path) -> {
                            b2.if_(b2.objEquals(b2.objToString(path), Const.of("./MANUAL.adoc")), b3 -> {
                                b3.set(found, true);
                                b3.break_(b1);
                            });
                        });
...
They may be easily invoked on any object using helper methods found directly on the block creator.
    ...
    public static void main(String[] ignored) {
        ...
        gizmo.class_("BasicMethods", cc -> {
            cc.staticMethod("main", mc -> {
                ...
                mc.body(b0 -> {
                    LocalVar arg = b0.localVar("arg", args.elem(0));
                    b0.printf("Hash of %s is %s%n", arg, b0.objToString(b0.objHashCode(arg)));
                    b0.if_(b0.objEquals(Const.of("ARcZguv"), arg), b1 -> {
...
**** `GenericType.OfTypeVariable` - representing the type of type variables
